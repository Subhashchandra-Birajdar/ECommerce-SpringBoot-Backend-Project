...
import com.subhashCart.repositories.OrderDao;
import com.subhashCart.services.OrderService;
...
public class OrderController {
    ...
    public ResponseEntity<Order> addTheNewOrder(
            @Valid @RequestBody OrderDTO odto,
    ...
    public Order cancelTheOrderByOrderId(
            @PathVariable("orderId") Integer orderId,
            @RequestHeader("token") String token){
    ...
    public ResponseEntity<Order> updateOrderByOrder(
    ...
    public Customer getCustomerDetailsByOrderId(
            @PathVariable("orderId") Integer orderId) {
